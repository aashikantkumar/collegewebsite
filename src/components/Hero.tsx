        ...
        <div id="home" className="relative min-h-screen overflow-hidden">
            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen pt-16">
                ...
                >
                    ...
                    <motion.span
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-cyan-400 text-sm font-medium mb-8 backdrop-blur-sm"
                    ...
                    {/* Hero Animation Container - Acts as dynamic heading */}
                    <motion.div
                        className="w-full h-[300px] mb-6 relative"
                        variants={floatVariants}
                    >
                        <SpiralAnimation />
                    </motion.div>
                    ...
                    <motion.p
                        className="max-w-2xl mx-auto text-xl text-gray-300 mb-10 drop-shadow-md"
                        variants={floatVariants}
                        animate={{ y: [0, -6, 0] }}
